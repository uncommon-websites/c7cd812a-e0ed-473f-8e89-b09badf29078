...
<script lang="ts">
	...
	name: "Founder, Lapel",
	role: "Founder & CEO",
	image: "/generated/image-a-confident-tech-founder-headshot-mid-30.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We kept seeing great teams and great companies fail their customers—because nobody had the full picture. So we built Lapel: living customer context, always up to date, always within reach."`}
    />
